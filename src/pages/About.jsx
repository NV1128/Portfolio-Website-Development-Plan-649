...
const About = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      avatar: "AS",
      skills: ["React", "JavaScript", "MongoDB", "UI/UX Design", "Database Management"],
      specializations: ["Frontend Development", "Database Management", "User Experience"],
      achievements: ["Designed 30+ user interfaces", "Database optimization expert", "UI/UX certification"],
