                ...
                <AnimatePresence>
                  {isExpanded && (
                    <motion.div
                      ...
                      className="absolute -top-14 left-1/2 transform -translate-x-1/2 bg-black/80 backdrop-blur-sm text-white text-xs px-3 py-2 rounded-lg border border-cyan-400/20 whitespace-nowrap pointer-events-none"
                      style={{
                        boxShadow: '0 4px 20px rgba(0,255,255,0.3)'
                      }}
                    >
                      {item.label}
                      <div className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-black/80 border-r border-b border-cyan-400/20 rotate-45" />
                    </motion.div>
                  )}
                </AnimatePresence>
              </motion.div>
